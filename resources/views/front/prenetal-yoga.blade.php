            ...
            <div class="row">
                        ...
                        <div class="row ">
                            <div class="col-xl-9 offset-xl-3 col-lg-12 col-12">
                                ...
                                <div class="form-cont-left">
                                    <h3 class="fs-title">Prenatal Yoga</h3>
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-select form-control" required=""
                                                                ...
                                                                <option value="PCOS/PCOD_Management ">PCOS/PCOD
                                                                    Management </option>
                                                                <option value="yoga_for-pregnant_ladies"  selected="" >Yoga For
                ...
                <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                    ...
                    <div class="desc-cont-right">
                        <div class="container">
                            <h3 class="title-cont mt-5">How our classes will help</h3>
                            <div class="row align-items-md-center">
                                <div class="col-lg-6 col-md-6 col-sm-12 mb-4">

                                    <img src="assets/images/prenatal-desc.jpg" class="cont-img-right">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                                    <div class="content-categ-cont">
                                        <p><span><strong>Description:</strong></span><br>"Discover the soothing embrace
                                            of our prenatal yoga classes, designed to nurture and support expectant
                                            mothers. Our classes offer a safe and gentle way to stay active during
                                            pregnancy, emphasizing relaxation, strength, and overall well-being. We're
                                            here to guide you through a balanced and healthy pregnancy journey."</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-md-center flex-md-row-reverse">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <img src="assets/images/prenatal-yoga.jpg" class="cont-img-right">
                                </div>

                                <div class="col-lg-6 col-md-6 col-sm-12">

                                    <div class="content-categ-cont">
                                        <p><span><strong>Prenatal Yoga Benefits:</strong></span><br> Pregnancy-safe
                                            practices for comfort and health.</p>
                                        <p>Expert guidance tailored to expectant mothers.</p>
                                        <p>Stress reduction and relaxation techniques.</p>
                                        <p>Preparation for a balanced and healthy pregnancy experience.</p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-12">
                            <picture>
                                <source media="(max-width:768px)" srcset="assets/images/icons/step2.png"
                                    class="img-fluid w-100" alt="step 4" />
                    ...
                    <div class="row mt-4">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="carousel_slider owl-carousel owl-theme" id="review-div" data-margin="15"
                                data-loop="true" data-autoplay="true" data-center="true" data-nav="true"
                                data-dots="false"
