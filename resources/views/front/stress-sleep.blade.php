        ...
        <div class="container-fluid p-0">
            <div class="row">
                <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                    <div class="container">
                        <div class="row ">
                            <div class="col-xl-9 offset-xl-3 col-12 col-lg-12">

                                <div class="form-cont-left">
                                    <h3 class="fs-title">De Stress & Improved sleep</h3>
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-select form-control" required=""
                                                                ...
                                                                <option value="general-fitness">General Fitness And
                                                                    Endurance</option>
                                                                <option value="de-stress" selected="" >De-Stress And Improved Sleep
                                                                </option>
                        ...
                        <div class="container">
                            ...
                            <div class="row align-items-md-center">
                                <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                                    <h5 class="title-cont-img">De-Stress</h5>
                                    <img src="assets/images/de-stress.jpg" class="cont-img-right">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 mb-4">

                                    <div class="content-categ-cont">
                                        <p>Our yoga classes offer effective stress relief through mindful breathing and
                                            relaxation techniques, helping you find inner calm and balance in a
                                            fast-paced world.</p>
                            ...
                            <div class="row flex-lg-row-reverse align-items-md-center">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <h5 class="title-cont-img">Improved Sleep</h5>
                                    <img src="assets/images/improved-sleep.jpg" class="cont-img-right">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">

                                    <div class="content-categ-cont">
                                        <p>Promote better sleep by reducing stress, enhancing relaxation, and calming
                                            the mind. The practices help you achieve restorative sleep patterns, leading
                                            to improved overall well-being.</p>
                                    </div>
                                </div>
                            </div>
