                        ...
                        <div class="row ">
                            <div class="col-xl-9 offset-xl-3 col-lg-12 col-12">
                                ...
                                <div class="form-cont-left">
                                    <h3 class="fs-title">PCOD & Hormonal Balance</h3>
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            <select class="form-select form-control" required=""
                                                                ...
                                                                <option value="PCOS/PCOD_Management" selected="" >PCOS/PCOD
                                                                    Management </option>
                        ...
                        <div class="container">
                            ...
                            <div class="row align-items-md-center">
                                <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                                    <h5 class="title-cont-img">PCOD</h5>
                                    <img src="assets/images/pcod.jpg" class="cont-img-right">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                                    <div class="content-categ-cont">
                                        <p>Tailored practices to address PCOD.</p>
                                        <p>Symptom relief and menstrual cycle regulation.</p>
                                        <p>Supportive environment for effective management.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row align-items-md-center flex-md-row-reverse">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <h5 class="title-cont-img">Hormonal Balance</h5>
                                    <img src="assets/images/hormonal.jpg" class="cont-img-right">
                                </div>

                                <div class="col-lg-6 col-md-6 col-sm-12">

                                    <div class="content-categ-cont">
                                        <p>Practices led by expert instructors.</p>
                                        <p>Targeted hormone regulation.</p>
                                        <p>Mitigation of imbalances and associated health concerns.</p>
                                        <p>Enhanced overall well-being.</p>
