                    ...
                    <div class="row ">
                        <div class="col-xl-9 offset-xl-3 col-lg-12 col-12">
                            ...
                            <div class="form-cont-left">
                                <h3 class="fs-title">Manage Thyroid, Back Pain & Diabetes</h3>
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                                    <div class="form-group">
                                                        <select class="form-select form-control" required=""
                                                            ...
                                                            <option value="thyroid_back_pain_&_diabetes" selected="" >Thyroid ,
                    ...
                    <div class="container">
                        ...
                        <div class="row align-items-md-center">
                            <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                                <h5 class="title-cont-img">Thyroid</h5>
                                <img src="assets/images/Thyroid.jpg" class="cont-img-right">
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 mb-4">

                                <div class="content-categ-cont">
                                    <p>Manage Thyroid, Back Pain & Diabetes</p>
                                    <p>Stimulates the thyroid gland to promote hormonal balance</p>
                                    <p>Supports improved thyroid function</p>
                        ...
                        <div class="row align-items-md-center flex-md-row-reverse">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                                <h5 class="title-cont-img">Back pain</h5>
                                <img src="assets/images/back-pain2.jpg" class="cont-img-right" />
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12 mb-4 order-md-2">

                                <div class="content-categ-cont">
                                    <p>Strengthens core muscles to enhance posture.</p>
                                    <p>Increases flexibility to reduce discomfort and prevent future pain.
                                    </p>
                        ...
                        <div class="row align-items-md-center">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <h5 class="title-cont-img">Diabetes</h5>
                                <img src="assets/images/Diabetes.jpg" class="cont-img-right" />
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">

                                <div class="content-categ-cont">
                                    <p>Regulates blood sugar levels, reducing stress and enhancing insulin
                                        sensitivity.</p>
                                    <p>Contributes to better glucose control and overall health.</p>
                                </div>
                            </div>
