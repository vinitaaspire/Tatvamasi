...
<!------start----contact--boxes----->
<section class="three-box-cont d-md-block d-none">
    <div class="container">
        <div class="row">
           <div class="col-lg-4 offset-lg-2 col-sm-12">
                    ...
                    <div class="contact-box box_shadow4 text-center contact-box_style1 animation" data-animation="fadeInRight"
                        ...
                        <div class="contact-icon">
                            <img src="assets\images\exchange-mails.png">
                        </div>
                        <div class="contact-desc">
                            <h5>EMAIL</h5>
                            <p>info@tatvamasi.com</p>
                        </div>
                    </div>
                </div>
                          ...
                          <div class="form-group">
                           ...
                           <div class="col-lg-12 col-md-6 col-12 col-sm-12" >
                            ...
                            <textarea  required data-error="Enter Your Address" placeholder="Enter Address" rows="4" cols="50"  class="form-control"  ></textarea>
                                                 ...
                                                 <div class="col-lg-12 col-md-12 col-12 col-sm-12" >
                                                    <button type="submit" title="Subscribe" name="submit" value="Submit"  class="btn btn-default submit-btn action-button animation animated fadeInUp" >Submit <img src="assets/images/icons/right-arrow-btn.png" class="btn-icn"></button>
                            </div>
                        </form>
            </div>
        </div>
