...
<div class="main-content">
          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <a href="{{ route('testimonial.index') }}" class="btn btn-success">
        ...
        <div class="col-sm-12 col-md-7">
            ...
            <img id="imagePreview" src="{{ asset($testimonial->profile_pic) }}" alt="Image Preview" style="max-width: 100%; max-height: 150px; display: block;">
        </div>
    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                       <input type="text" name="designation" id="" class="form-control " value="{{$testimonial->designation ?? ''}}" >
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                       <textarea  name="desc" class="summernote" > {!! $testimonial->desc ?? '' !!}</textarea>
                      </div>
                    </div>
