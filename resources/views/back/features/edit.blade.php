...
<div class="main-content">
          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <a href="{{ route('feature.index') }}" class="btn btn-success">
                    <i class="fas fa-arrow-left"></i> Back to Features
                </a>
             <h4>Edit Feature</h4> 
              </div>
                  <div class="card-body">
                    <form action="{{ route('feature.update', ['feature' => $feature->id]) }}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
                        @csrf
        ...
        <div class="col-sm-12 col-md-7">
            ...
            <img id="imagePreview" src="{{ asset($feature->image) }}" alt="Image Preview" style="max-width: 100%; max-height: 150px; display: block;">
        </div>
    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                       <textarea  name="description" class="summernote" > {!! $feature->description ?? '' !!}</textarea>
                      </div>
                    </div>
