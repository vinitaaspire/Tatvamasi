          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                ...
                <form action="{{route('trainers.create')}}" method="get">
                  ...
                  <table class="table table-striped"  id="table-1" >
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <!-- Status Update Form -->
                          <form action="{{ route('trainers.show', ['trainer' => $list->id]) }}" method="GET">
                            @csrf
                        ...
                        <td>{{ $list->order }}</td>
                        <td>
                          <form action="{{ route('trainers.edit', ['trainer' => $list->id]) }}" method="GET" class="d-inline">
                            @csrf
                            <button type="submit" class="edit badge badge-primary btn btn-primary"><i class="fas fa-edit" ></i></button>
                          </form>

                          <form id="deleteForm{{ $list->id }}" action="{{ route('trainers.destroy', ['trainer' => $list->id]) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
